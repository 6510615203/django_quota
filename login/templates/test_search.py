...
class SearchTemplateTest(TestCase):
    ...
    def test_search_template_renders_correctly(self):
        ...
        # เรียกหน้า search
        response = self.client.get(reverse('login/templates/search.html'))
    ...
    def test_search_template_displays_subject_list(self):
        # ล็อกอินด้วยผู้ใช้ทดสอบ
        self.client.login(username='6510615096', password='usertest1')
    ...
    def test_search_template_has_css_and_title(self):
        # ล็อกอินด้วยผู้ใช้ทดสอบ
        self.client.login(username='6510615096', password='usertest1')
        ...
        self.assertContains(response, "/static/css/searchstyle.css")
        self.assertContains(response, "<title>ค้นหารายวิชา</title>")
